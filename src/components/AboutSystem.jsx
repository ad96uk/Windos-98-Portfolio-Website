...
export default function AboutSystem({onClick}) {
  return (
    <Draggable bounds="parent">
      <div className="about-system x-window flex flex-col w-[375px] cardAndTableBorder box-shadow bg-customGrey p-1">
        <div className="flex justify-between w-full h-8 title-bar cursor-grab mb-2">
          <div className="flex flex-row items-center justify-center gap-2 p-1 ">
            <p className="text-white">System info</p>
          </div>
        ...
        <div className="h-[150px] flex flex-col justify-center align-middle items-center gap-2">
          <Image src={"/alert.png"} height={32} width={32} alt="alert" />
            <p className="text-center">This website is built using<br />Next.js and Headless WordPress.</p>
            <div className='flex flex-row gap-6'><img src={'/react.svg'} className="logo-react" alt="React logo" />
            <img src={'/Wordpress-Logo.svg'} className="logo-wp" alt="WP logo" /></div>
        </div>
