...
export default function BottomMenu({openCv, openPortfolio, openTerminal}) {
  return (
    <div className="flex flex-row bg-customGrey fixed bottom-[62px] left-[2px] h-[338px] w-[250px] cardAndTableBorder box-shadow">
